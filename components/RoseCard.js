  ...
  return (
    <Link id="card" href={`/rose/${slug.current}`}>
      <a className="bg-gray-300 w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
        ...
        >
          <button className="p-2 rounded-full bg-white text-blue-500 mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
            <svg
              className="h-5 w-5"
              fill="none"
              strokeLinecap="round"
        ...
        <div id="card" className="px-5 py-3">
          <h3 id="card" className="text-gray-700 uppercase">{title}</h3>
